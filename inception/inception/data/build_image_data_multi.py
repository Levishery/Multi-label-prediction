...
# replace label file with a list
tf.app.flags.DEFINE_string('vali_labels_file', '', 'Labels file for validation')

tf.app.flags.DEFINE_string('train_labels_file', '', 'Labels file for training')

Attr_type = ["5_o_Clock_Shadow", "Arched_Eyebrows", "Attractive", "Bags_Under_Eyes", "Bald", "Bangs", "Big_Lips", "Big_Nose", "Black_Hair", "Blond_Hair", "Blurry", "Brown_Hair", "Bushy_Eyebrows", "Chubby", "Double_Chin", "Eyeglasses", "Goatee", "Gray_Hair", "Heavy_Makeup", "High_Cheekbones", "Male", "Mouth_Slightly_Open", "Mustache", "Narrow_Eyes", "No_Beard", "Oval_Face", "Pale_Skin", "Pointy_Nose", "Receding_Hairline", "Rosy_Cheeks", "Sideburns", "Smiling", "Straight_Hair", "Wavy_Hair", "Wearing_Earrings", "Wearing_Hat", "Wearing_Lipstick", "Wearing_Necklace", "Wearing_Necktie", "Young"]
...
def _process_image_files_batch(coder, thread_index, ranges, name, filenames, labels, num_shards):
  ...
  Args:
    ...
    labels: list of list; each list identifies the ground truth attribute
...
def _build_image_label(data_dir, label_file):
  ...
  with open(label_file, "r") as Attr_file:
    ...
    for line in Attr_info:
      ...
      info_num.append(0)
      info = line.split()
      file_path = os.path.join(data_dir, info[0])
...
def _process_dataset(name, directory, num_shards, label_file):
  ...
  """
  filenames, labels = _build_image_label(directory, label_file)
...
def main(unused_argv):
  ...
  _process_dataset('validation', FLAGS.validation_directory,
                   FLAGS.validation_shards, FLAGS.vali_labels_file)
